define("xg/eid-company-zy/1.0.4/c/js/base/sm-city-picker-extend-debug", ["xg/eid-company-zy/1.0.4/"], function(require, exports, module) {
    + function($) {
        "use strict";
        var area = require("xg/eid-company-zy/1.0.4/");
        var china = [],
            p = area.getProvince(),
            c = [];
