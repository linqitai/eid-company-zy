define("xg/eid-company-zy/1.0.4/p/customerParent/login/index-debug", ["jquery/jquery/1.10.1/jquery-debug", "xg/eid-company-zy/1.0.4/c/js/tools-debug", "xg/eid-company-zy/1.0.4/c/js/bootstrap-debug", "xg/eid-company-zy/1.0.4/c/js/jquery-debug.validate", "xg/eid-company-zy/1.0.4/c/js/validate-add-methods-debug", "xg/eid-company-zy/1.0.4/c/js/validate-messages-cn-debug", "xg/eid-company-zy/1.0.4/c/js/moment-debug", "xg/eid-company-zy/1.0.4/c/handlebars/headerTmp-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/modifyPassword-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/modifyInfo-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/showCheckInfo-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/versionH-debug.handlebars", "xg/eid-company-zy/1.0.4/p/customerParent/login/loginH-debug.handlebars"], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug"),
        tools = require("xg/eid-company-zy/1.0.4/c/js/tools-debug");
    var main = {
        init: function() {
            var self = this;
            var loginH = require("xg/eid-company-zy/1.0.4/p/customerParent/login/loginH-debug.handlebars");
...
define("xg/eid-company-zy/1.0.4/p/customerParent/login/loginH-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
