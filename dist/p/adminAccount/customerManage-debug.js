define("xg/eid-company-zy/1.0.4/p/adminAccount/customerManage-debug", ["jquery/jquery/1.10.1/jquery-debug", "xg/eid-company-zy/1.0.4/c/js/tools-debug", "xg/eid-company-zy/1.0.4/c/js/bootstrap-debug", "xg/eid-company-zy/1.0.4/c/js/jquery-debug.validate", "xg/eid-company-zy/1.0.4/c/js/validate-add-methods-debug", "xg/eid-company-zy/1.0.4/c/js/validate-messages-cn-debug", "xg/eid-company-zy/1.0.4/c/js/moment-debug", "xg/eid-company-zy/1.0.4/c/handlebars/headerTmp-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/modifyPassword-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/modifyInfo-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/showCheckInfo-debug.handlebars", "xg/eid-company-zy/1.0.4/c/handlebars/versionH-debug.handlebars", "xg/eid-company-zy/1.0.4/c/js/jquery-debug.provincesCity", "xg/eid-company-zy/1.0.4/c/js/provincesData-debug", "xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/addCustomerH-debug.handlebars", "xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/customerMH-debug.handlebars", "xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/customerTableH-debug.handlebars"], function(require, exports, module) {
    ...
    var addCustomerH = require("xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/addCustomerH-debug.handlebars"),
        customerMH = require("xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/customerMH-debug.handlebars"),
        customerTableH = require("xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/customerTableH-debug.handlebars"),
        data = {
            pageIndex: 1,
            pageSize: 10
        };
...
define("xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/addCustomerH-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company-zy/1.0.4/p/adminAccount/customerManageH/customerMH-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
