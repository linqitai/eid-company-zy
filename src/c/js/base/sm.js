  ...
  var Picker = function (params) {
      ...
      p.updateValue = function () {
          ...
          for (var i = 0; i < p.cols.length; i++) {
              ...
              //console.log(p.cols[i].displayValue)
          }
      ...
      var tomorrow=new Date(nowdate.getTime()+24*60*60*1000-1);
      var nowyear=tomorrow.getFullYear();
      var thirtylater=new Date(tomorrow.getTime()+30*24*60*60*1000-1);
      ...
      //if(!p.params.documentclickClose){
      if (!p.inline)$('html').on('click', closeOnHTMLClick);
      //}
      // Open
      function onPickerClose() {
...
+ function($) {
  ...
  var initYears = (function () {
    ...
    var arr = [];
    for (var i = year; i <= myDate.getFullYear(); i++) { arr.push(i); }
    return arr;
  })();
